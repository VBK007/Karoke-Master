...
$channelID  = 'UCVDh56YgkQlWhsoUfh-DxcA';
$maxResults = 50;

$videoList = json_decode(file_get_contents('https://www.googleapis.com/youtube/v3/search?order=date&part=snippet&channelId='.$channelID.'&maxResults='.$maxResults.'&key='.$API_key.''));

// $videoList = json_decode(file_get_contents('https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&playlistId='.$channelID.'&maxResults='.$maxResults.'&key='.$API_key.''));
...
<div class="demo-layout-transparent mdl-layout mdl-js-layout">
  ...
  <div class="mdl-layout__drawer">
    ...
    <nav class="mdl-navigation">
      ...
      <a class="mdl-navigation__link" href="">OldSongs</a>
